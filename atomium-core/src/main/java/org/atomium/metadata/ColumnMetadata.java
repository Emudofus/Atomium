 ...
 * @author Blackrush
 */
public abstract class ColumnMetadata<T> extends SimpleAttribute<T, Object> implements ColumnInfo {
    private final Metadata<T> parent;
    private final String name;
    private final TypeToken<?> target;
    private boolean primaryKey, autogenerated, nullable;

    public ColumnMetadata(Metadata<T> parent, String name, TypeToken<?> target) {
        //noinspection unchecked
        super(parent.getTarget(), (Class<Object>) target.getRawType(), name);
    ...
    public <A> Attribute<T, A> asAttribute() {
        return (Attribute<T, A>) this;
    }
}
